    ...
    <div className="flex flex-col justify-between h-full">
      <ul>
        ...
        <li>
          <a
            href="../"
            className="flex items-center gap-2 border-s-[3px] border-transparent px-4 py-3 text-gray-500 hover:border-[#3E4811] hover:bg-[#cae06c] hover:text-gray-700"
          >
           <svg
            ...
            >
              <path
                fillRule="evenodd"
                d="M10 3.22l7.61 6.76c.15.13.23.31.23.5v6.5a1 1 0 01-1 1H3.15a1 1 0 01-1-1v-6.5c0-.19.08-.37.22-.5L10 3.22zm-1-1.72l-8 7V17a2 2 0 002 2h14a2 2 0 002-2v-8.5l-8-7a1 1 0 00-1.41 0z"
                clipRule="evenodd"
              />
            </svg>
          </a>

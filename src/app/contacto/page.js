    ...
    <div className="card-inner active" id="about-card">
      <div className="row card-container">
        ...
        >
          ...
          >
            <div class="card-image col col-m-12 col-t-12 col-d-4 col-d-lg-6" style={{ backgroundImage: "url('/fondo2.jpeg')" }}>
            ...
            <div className="content contacts-info !mt-[-10px] !pt-0">
              ...
              <div className="row contacts-items text-[0]">
                <a href="https://github.com/IreeneGG/Web-Tfg" target="_blank" rel="noopener noreferrer" className="no-underline">
                  <div className="col col-m-12 col-t-6 col-d-6 col-d-lg-6">
                    <div className="contacts-item card-box min-h-[87px] text-left !py-[20px] !pr-[20px] !pl-[75px]">
                      ...
                      <div className="name m-0 text-[16px] leading-[20px] text-white font-bold">Github</div>
                      <p className="m-0">IreeneGG</p>
                    </div>
                  </div>
                </a>

                <a href="https://www.linkedin.com/in/irene-gonz%C3%A1lez-gonz%C3%A1lez-97344b2b7/" target="_blank" rel="noopener noreferrer" className="no-underline">
                <div className="col col-m-12 col-t-6 col-d-6 col-d-lg-6">
                  <div className="contacts-item card-box min-h-[87px] text-left !py-[20px] !pr-[20px] !pl-[75px]">
                    <div className="icon m-0 absolute left-[20px] top-[20px] w-[40px] h-[40px] leading-[40px] text-[40px] text-extra-color">
                      <Image
                ...
                <a href="https://www.google.com/intl/es/gmail/about/" target="_blank" rel="noopener noreferrer" className="no-underline">
                <div className="col col-m-12 col-t-6 col-d-6 col-d-lg-6">
                  <div className="contacts-item card-box min-h-[87px] text-left !py-[20px] !pr-[20px] !pl-[75px]">
                    <div className="icon m-0 absolute left-[20px] top-[20px] w-[40px] h-[40px] leading-[40px] text-[40px] text-extra-color">
                      <Image
                    ...
                    <div className="name m-0 text-[16px] leading-[20px] text-white font-bold">Gmail</div>
                    <p className="m-0">irenegonzalez@opendeusto.es</p>
                  </div>
                </div>
                </a>
                <div className="col col-m-12 col-t-6 col-d-6 col-d-lg-6">
    ...
    (<section class="flex justify-center items-center">
      ...
      >
        <svg
          ...
          width="2em" // Aumentar el tamaño del icono
          height="2em" // Aumentar el tamaño del icono
          viewBox="0 0 24 24"
          stroke-width="1"
          fill="currentColor"
          stroke="currentColor"
